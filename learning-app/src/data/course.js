...
export const COURSE = {
  core: {
    ...
    items: [
      ...
      { id: '15', title: '15_GiveLesson', path: '15_GiveLesson', topics: 'Callbacks, forEach, reduce', prereqs: ['14'], related: ['14', '16'] },
      { id: '16', title: '16_GiveLesson', path: '16_GiveLesson', topics: 'Primitive vs reference, timers', prereqs: ['15'], related: ['15', '17'] },
      ...
      { id: '21', title: '21_GiveLesson', path: '21_GiveLesson', topics: 'DOM', prereqs: ['20'], related: ['20', '22'] },
      { id: '22', title: '22_GiveLesson', path: '22_GiveLesson', topics: 'Cloning, innerHTML, events, sliders, target/currentTarget', prereqs: ['21'], related: ['21', '23'] },
      ...
      { id: '29', title: '29_GiveLesson', path: '29_GiveLesson', topics: 'Getter/setter, __proto__, prototype', prereqs: ['28'], related: ['28', '30'] },
      { id: '30', title: '30_GiveLesson', path: '30_GiveLesson', topics: 'ES6 class, inheritance, Object.create', prereqs: ['29'], related: ['29', '31'] },
